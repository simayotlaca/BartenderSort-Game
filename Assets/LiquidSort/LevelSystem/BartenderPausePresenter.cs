...
namespace LiquidSort.Levels
{
    ...
    public sealed class BartenderPausePresenter : MonoBehaviour
    {
        ...
        private bool pauseMenuRequestQueuedValue;
        private bool pauseMenuRequestQueued
        {
            get => pauseMenuRequestQueuedValue;
            set
            {
                pauseMenuRequestQueuedValue = value;
                if (controller != null) controller.PauseRequestPending = value;
            }
        }
        ...
        private void RequestPauseMenuNow()
        {
            ...
            bool temporarilyBlocked = controller.PresentationLocked || controller.PersistencePending
        ...
        private void FlushQueuedPauseMenuRequest()
        {
            ...
            if (controller.PresentationLocked || controller.PersistencePending
                || controller.QueuedCommandCount > 0) return;
            pauseMenuRequestQueued = false;
            RequestPauseMenuNow();
        }
