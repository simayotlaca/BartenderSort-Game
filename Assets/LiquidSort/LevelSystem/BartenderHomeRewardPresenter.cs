    ...
    public sealed class BartenderHomeRewardPresenter : MonoBehaviour
    {
        ...
        private bool EnsurePool()
        {
            ...
            for (int i = 0; i < CoinPoolSize; i++)
            {
                ...
                {
                    ReportPoolBindingError(
                        $"Reward coin {i + 1:00} binding invalid.");
                    return false;
                }
            }
            return true;
