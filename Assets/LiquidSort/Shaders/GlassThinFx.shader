...
Shader "LiquidSort/GlassThinFX"
{
    Properties
    {
        ...
        [PerRendererData] _DeliveryOpacity ("Delivery Opacity", Range(0,1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f_fx input) : SV_Target
            {
                ...
                // Every additive light term is gated by source alpha. Exact-zero pixels
                // contribute nothing; keep all nonzero alpha to preserve thin glass edges.
                clip(sourceAlpha > 0.0 ? 1.0 : -1.0);
                ...
                return fixed4((sideLight + floorLight + modelledLight
                    + partLight) * saturate(_DeliveryOpacity), 0.0);
            }
            ENDCG
        }
    }
