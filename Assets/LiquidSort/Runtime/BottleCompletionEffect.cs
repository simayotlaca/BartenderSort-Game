    ...
    public sealed class BottleCompletionEffect : MonoBehaviour
    {
        ...
        private bool EnsureVisuals()
        {
                ...
                || frontSpiralMesh == null || frontSpiralRenderer == null)
            {
                ...
                {
                    Debug.LogError(
                        "Completion effect bindings missing.",
                        this);
            ...
            if (shader == null)
            {
                ...
                {
                    Debug.LogError(
                        "Completion shader missing; effect skipped.",
                        this);
                    shaderErrorLogged = true;
                }
                return false;
                                        ...
                                        bool restoreMotion, bool killTween)
        {
            ...
            try
            {
                ...
                // Failed cleanup cannot emit the success cue.
            ...
            // Clear state before returning the object to its pool.
            InvokeCue(finished);
        }
